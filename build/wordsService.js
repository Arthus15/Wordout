...
function initTable() {
    return __awaiter(this, void 0, void 0, function () {
        var words, resultRows, tableBody;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db.selectAllAsync('SELECT * FROM words ORDER BY word ASC')];
                case 1:
                    words = _a.sent();
                    resultRows = '';
...
function deleteWord(word) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    row = document.getElementById(word);
                    if (row)
                        row.remove();
                    window.resizeBy(0, 0);
                    return [4 /*yield*/, db.execAsync("DELETE FROM words WHERE word = '" + word + "';")];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
